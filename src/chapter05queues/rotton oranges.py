# Link: https://github.com/trigodeepak/Programming/blob/master/rotten%20oranges.py
# 2. https://github.com/trigodeepak/Programming/blob/master/rotton%20oranges.py
# IsDone: 0
row = [-1,1,0,0]
col = [0,0,-1,1]
